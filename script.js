document.addEventListener('DOMContentLoaded', function() {
    ...
    const songs = [
        {
            title: "Maloqueiro Sorridente",
            artist: "MC Kevin",
            media: {
                type: "video",
                source: "assets/media/music0.mp4"
            },
            src: "assets/music/song0.mp3"
        },
        {
            title: "País da Fome",
            artist: "Sabotage",
...
const titles = ["</>", "!", "!C", "!Co", "!Cor", "!Cort", "!Corte", "!Cortez", "!Corteza", "!Cortezad", "!Cortezada", "!Cortezadas", "!Cortezadass", "!Cortezadass7"];
let index = 0;
